...
function MakerQuestionCard({ question, onUpdate, onDelete, createNewOption, error = {}, isEditable = true }) {
    const {
        ...
        transition,
        isDragging,
    } = useSortable({ id: question.id || question.questionID });
    const style = {
    ...
    return (
        <div className="frame maker-question-card" ref={setNodeRef} style={style}>
            {isEditable &&
                <div {...attributes} {...listeners} style={{ cursor: 'grab' }}>
                    <IconGripHorizontal className="icon-primary" color="#777777" />
                </div>
            }
